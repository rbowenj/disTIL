...
outputs:
  ...
  - id: disTIL_report
    ...
    doc: HTML report summarising disTIL analysis.
    'sbg:x': 2727.994140625
    'sbg:y': 886.811279296875
steps:
  - id: tmb
    in:
      - id: vcf
  ...
  - id: distil_report
    in:
      ...
      - id: patient_id
        source: patient_id
      - id: pvacseq_i
        source: pvactools_neoepitope_prediction_1/mhc_i_filtered_epitopes
      - id: pvacseq_ii
        source: pvactools_neoepitope_prediction_1/mhc_ii_filtered_epitopes
      - id: pvacfuse_i
        source: pvactools_neoepitope_prediction_1/pvacfuse_star_filtered_mhc_i
      - id: pvacfuse_ii
        source: pvactools_neoepitope_prediction_1/pvacfuse_star_filtered_mhc_ii
      ...
      - id: quant_deconv
        source: immunedeconv_1/quanitseq_deconv
    out:
      - id: disTIL_report
    run: ../tools/distil-report.cwl
    label: distil-report
    'sbg:x': 2321.090576171875
    'sbg:y': 877.085693359375
requirements:
